...
export const IntroductoryHeaderSection = (): JSX.Element => {
  return (
          ...
          <div className="flex-col max-w-screen-xl items-center gap-8 w-full flex-[0_0_auto] flex px-8 py-0 relative">
            <div className="flex flex-col items-start gap-12 relative self-stretch w-full flex-[0_0_auto]">
              <div className="flex items-center justify-center gap-6 relative self-stretch w-full flex-[0_0_auto]">
                ...
                <p className="w-[640px] mt-[-1.00px] text-[#dbece6] text-[length:var(--text-xl-regular-font-size)] leading-[var(--text-xl-regular-line-height)] relative font-text-xl-regular font-[number:var(--text-xl-regular-font-weight)] tracking-[var(--text-xl-regular-letter-spacing)] [font-style:var(--text-xl-regular-font-style)]">
                  單機架420 kWh解決方案，具備380 kWh可用能量、200
                  kW峰值功率，並在IP65等級外殼中實現&gt; 94%的回程效率。
                </p>
              </div>

              <img
                className="relative self-stretch w-full flex-[0_0_auto]"
                alt="Cold OG2 高容量能源模組產品圖片"
