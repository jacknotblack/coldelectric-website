...
export const FeaturesOverviewSection = (): JSX.Element => {
  const features: FeatureItem[] = [
    {
      icon: "https://c.animaapp.com/mhbgaqp12GzVxu/img/link-broken-01.svg",
      iconAlt: "Link broken",
      title: "在電網故障期間運行",
      description: "無縫轉供至在地電源...以確保您的關鍵負載持續運行。",
    },
    {
      icon: "https://c.animaapp.com/mhbgaqp12GzVxu/img/zap-1.svg",
      iconAlt: "Zap",
      title: "通過負載平衡降低能源成本",
      description:
    ...
    {
      icon: "https://c.animaapp.com/mhbgaqp12GzVxu/img/chart-breakout-square.svg",
    ...
    {
      icon: "https://c.animaapp.com/mhbgaqp12GzVxu/img/featured-icon.svg",
  ...
  return (
    <section
      className="flex flex-col items-center gap-16 px-0 py-24 relative self-stretch w-full flex-[0_0_auto] z-[4]"
        ...
        <div className="flex flex-col items-start gap-12 relative self-stretch w-full flex-[0_0_auto]">
          <div className="flex max-w-screen-md items-start gap-5 w-full flex-[0_0_auto] flex-col relative">
            ...
            <p className="self-stretch font-normal text-[#dbece6] text-sm leading-5 relative [font-family:'Manrope',Helvetica] tracking-[0]">
              併網型儲能系統 (Grid-Connected Energy Storage System)
              是一種連接到電網的電池儲能解決方案。它能從電網充電、向電網放電,
              並提供多種輔助服務, 確保電網穩定運行。
            </p>
          </div>
        </div>
